...
lich_event = """
    ...
    set_repeat 0x4
    .Label_1:
    db 0x18 0x8 0xa 0x1 0xff 0xff 0xff 0xff
    delay 8
    repeat 0x1 .Label_1
    delay 20
    npc_update 0x2 0xa
    ...
    music 0x5 0x2           ; Fade BGM (fast)
    music 0xa 0xffff        ; Wait for fade
    load_text WINDOW_TOP %lich_text_id
    music 0x0 0x21          ; Play fanfare
    show_dialog
    music 0x9 0xffff        ; Wait for fanfare to finish
    close_dialog DIALOG_WAIT
...
kary_event = """
    ...
    set_repeat 0x4
    .Label_5:
    db 0x18 0x8 0x0 0x1 0xff 0xff 0xff 0xff
    delay 8
    repeat 0x1 .Label_5
    delay 60
    npc_update 0x2 0x0
    db 0xaa 0x4 0x1 0x1
    db 0x2b 0x4 0x5 0xff
    remove_all 0x13a8
    move_party 1 2 0
    db 0x3b 0x4 0xff 0xff
    npc_update 0x2 0xc
    ...
    music 0x5 0x2           ; Fade BGM (fast)
    music 0xa 0xffff        ; Wait for fade
    load_text WINDOW_TOP %kary_text_id
    music 0x0 0x21          ; Play fanfare
    show_dialog
    music 0x9 0xffff        ; Wait for fanfare to finish
    close_dialog DIALOG_WAIT
...
kraken_event = """
    ...
    music 0x5 0x2           ; Fade BGM (fast)
    music 0xa 0xffff        ; Wait for fade
    load_text WINDOW_TOP %kraken_text_id
    music 0x0 0x21          ; Play fanfare
    show_dialog
    music 0x9 0xffff        ; Wait for fanfare to finish
    close_dialog DIALOG_WAIT
...
tiamat_event = """
    ...
    music 0x5 0x2           ; Fade BGM (fast)
    music 0xa 0xffff        ; Wait for fade
    load_text WINDOW_TOP %tiamat_text_id
    music 0x0 0x21          ; Play fanfare
    show_dialog
    music 0x9 0xffff        ; Wait for fanfare to finish
    close_dialog DIALOG_WAIT
