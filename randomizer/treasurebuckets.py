...
class TreasureBuckets:
    def __init__(self):
        ...
        self.buckets = {
            ...
            "Weapon_B": [0x10, 0x11, 0x12, 0x13, 0x16, 0x17, 0x19, 0x1A, 0x1B, 0x1D, 0x1E, 0x1F, 0x21, 0x23, 0x24, 0x2F,
                         0x31, 0x33, 0x35, 0x3A, 0x3B, 0x3E],
            "Weapon_A": [0x14, 0x15, 0x18, 0x20, 0x22, 0x25, 0x26, 0x27, 0x2D, 0x30, 0x32, 0x34, 0x36, 0x37, 0x38, 0x39,
                         0x3D, 0x3F, 0x40],
            ...
            "Armor_B": [0x05, 0x06, 0x0D, 0x1A, 0x1F, 0x20, 0x24, 0x28, 0x29, 0x2E, 0x35, 0x38, 0x3E, 0x40, 0x41, 0x42,
                        0x44, 0x46],
            "Armor_A": [0x07, 0x08, 0x09, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x16, 0x17, 0x21, 0x22, 0x2F, 0x31, 0x32, 0x33,
                        0x34, 0x3F, 0x43],
    ...
    def get_bucket(self, itemType: int, id_val: int):
        if itemType == 1:
